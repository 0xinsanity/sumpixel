...
const SumpixelHeader = styled_components__WEBPACK_IMPORTED_MODULE_7___default()(antd__WEBPACK_IMPORTED_MODULE_1__["PageHeader"]).withConfig({
  displayName: "NavigationBar__SumpixelHeader",
  componentId: "sc-14u4r04-0"
})(["background:#DAE2EF;padding:30px 8%;"]);
const LogoutButton = styled_components__WEBPACK_IMPORTED_MODULE_7___default()(antd__WEBPACK_IMPORTED_MODULE_1__["Button"]).withConfig({
...
const Line = styled_components__WEBPACK_IMPORTED_MODULE_7___default.a.div.withConfig({
  displayName: "NavigationBar__Line",
  componentId: "sc-14u4r04-2"
})(["border:0.5px solid #000000;margin-top:10px;margin-bottom:10px;"]);
const SubTitle = styled_components__WEBPACK_IMPORTED_MODULE_7___default()(antd__WEBPACK_IMPORTED_MODULE_1__["Typography"].Title).withConfig({
