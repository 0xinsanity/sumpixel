...
const Profile = () => {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    if (profile_id !== undefined) {
      console.log('id' + profile_id); //changeId(profile_id as string)
    }
  }, [profile_id]);
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    setLoading(true);
    ...
    Object(_lib_server__WEBPACK_IMPORTED_MODULE_4__["getUser"])(id).then(profile => {
      ...
      console.error('ERROR IS HERE' + error); //OpenPage(setLoading, '/')
    });
  }, [id]);
...
//# sourceMappingURL=[profile_id].js.bdad1d185e7be6167ccb.hot-update.js.map