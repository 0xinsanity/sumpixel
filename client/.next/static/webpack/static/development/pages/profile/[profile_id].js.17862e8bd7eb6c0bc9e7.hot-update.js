...
const Profile = () => {
  ...
  const connectWithPerson = async () => {
    ...
    } else if (currentUser === undefined || currentUser.isAnonymous) {
      // Not logged in
  ...
  }, currentUser === undefined || currentUser.isAnonymous ? 'Sign Up To' : null, " Connect")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_dashboard_employer__WEBPACK_IMPORTED_MODULE_6__["Background"], {
    style: {
      height: '100%'
    }
...
//# sourceMappingURL=[profile_id].js.17862e8bd7eb6c0bc9e7.hot-update.js.map