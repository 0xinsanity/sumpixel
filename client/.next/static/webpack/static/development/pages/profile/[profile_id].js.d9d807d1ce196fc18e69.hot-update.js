...
const Profile = () => {
  ...
  const connectWithPerson = async () => {
    if (showStats) {
      ...
      const communications = lodash__WEBPACK_IMPORTED_MODULE_14___default.a.map(currentUser.communications, async commId => await Object(_lib_server__WEBPACK_IMPORTED_MODULE_5__["getDesignerFromCommunication"])(commId));
...
//# sourceMappingURL=[profile_id].js.d9d807d1ce196fc18e69.hot-update.js.map