...
const Profile = () => {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    ...
    setLoading(true);
    Object(_lib_server__WEBPACK_IMPORTED_MODULE_4__["getUser"])(profile_id).then(profile => {
      Object(_lib_server__WEBPACK_IMPORTED_MODULE_4__["getQAById"])(profile_id).then(qAndA => {
        changeQandA(qAndA);
      });
...
//# sourceMappingURL=[profile_id].js.3a03bf50806090d2ab86.hot-update.js.map