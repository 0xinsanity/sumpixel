...
const Profile = () => {
  ...
  const connectWithPerson = async () => {
    if (showStats) {
      ...
      if (lodash__WEBPACK_IMPORTED_MODULE_14___default.a.findIndex(currentUser.communications, comm => comm.designerId === profile_id) !== -1) {
...
//# sourceMappingURL=[profile_id].js.4751b6d37f1fd589ea84.hot-update.js.map