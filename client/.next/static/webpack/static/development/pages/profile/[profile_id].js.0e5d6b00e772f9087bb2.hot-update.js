...
const Profile = () => {
  ...
  const connectWithPerson = async () => {
    if (showStats) {
      ...
      const communications = await lodash__WEBPACK_IMPORTED_MODULE_14___default.a.map(currentUser.communications, async commId => await Object(_lib_server__WEBPACK_IMPORTED_MODULE_5__["getDesignerFromCommunication"])(commId));

      if (lodash__WEBPACK_IMPORTED_MODULE_14___default.a.findIndex(communications, comm => comm.designerId === profile_id) !== -1) {
...
//# sourceMappingURL=[profile_id].js.0e5d6b00e772f9087bb2.hot-update.js.map