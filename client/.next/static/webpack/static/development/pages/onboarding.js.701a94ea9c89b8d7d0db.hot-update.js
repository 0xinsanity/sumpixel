...
/* harmony import */ var _General_OpenPage__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../General/OpenPage */ "./components/General/OpenPage.tsx");
/* harmony import */ var _General_SumpixelCard__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../General/SumpixelCard */ "./components/General/SumpixelCard.tsx");
/* harmony import */ var _General_BackNext__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../General/BackNext */ "./components/General/BackNext.tsx");
...
const Onboard = props => {
  ...
  const updateEmployer = async updatedUser => {
    ...
    changeUser(updatedUser);
    await Object(_lib_server__WEBPACK_IMPORTED_MODULE_7__["createEmployer"])(updatedUser);
  };
  ...
  switch (currentStep) {
    ...
    case 2:
      if (navBarStatus == _model_model__WEBPACK_IMPORTED_MODULE_3__["NavBarStatus"].Designer) {
        Object(_General_OpenPage__WEBPACK_IMPORTED_MODULE_8__["default"])(setLoading, '/dashboard_user');
      } else {
        Object(_General_OpenPage__WEBPACK_IMPORTED_MODULE_8__["default"])(setLoading, '/dashboard_employer');
      }
  ...
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_General_SumpixelCard__WEBPACK_IMPORTED_MODULE_9__["SumpixelCard"], {
    withLogo: false
  ...
  }, currentForm), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_General_BackNext__WEBPACK_IMPORTED_MODULE_10__["default"], {
    backClick: backClick,
    nextClick: nextClick
  }))));
};
...
//# sourceMappingURL=onboarding.js.701a94ea9c89b8d7d0db.hot-update.js.map