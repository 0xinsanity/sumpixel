...
const DashboardEmployer = props => {
  ...
  const [isAnonymousHere, setAnonymous] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false);
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    window.analytics.page('Employer Dashboard');
    setTimeout(() => {
      console.log('valueset' + isAnonymousHere);

      if (!isAnonymousHere && (currentUser === null || currentUser === undefined)) {
...
//# sourceMappingURL=dashboard_employer.js.7c8c3c969aaa586d909e.hot-update.js.map