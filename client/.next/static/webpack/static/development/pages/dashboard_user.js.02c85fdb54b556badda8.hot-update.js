...
const SumpixelHeader = Object(styled_components__WEBPACK_IMPORTED_MODULE_5__["default"])(antd__WEBPACK_IMPORTED_MODULE_1__["PageHeader"]).withConfig({
  displayName: "NavigationBar__SumpixelHeader",
  componentId: "sc-14u4r04-0"
})(["background:#DAE2EF;padding:30px 8%;min-height:100vh;"]);
const LogoutButton = Object(styled_components__WEBPACK_IMPORTED_MODULE_5__["default"])(antd__WEBPACK_IMPORTED_MODULE_1__["Button"]).withConfig({
  displayName: "NavigationBar__LogoutButton",
  componentId: "sc-14u4r04-1"
})(["color:#000000;padding-top:10px;font-family:'Mark Pro Bold';"]);
const Line = styled_components__WEBPACK_IMPORTED_MODULE_5__["default"].div.withConfig({
  displayName: "NavigationBar__Line",
  componentId: "sc-14u4r04-2"
})(["border:0.5px solid #000000;margin-top:10px;margin-bottom:10px;"]);
const SubTitle = Object(styled_components__WEBPACK_IMPORTED_MODULE_5__["default"])(antd__WEBPACK_IMPORTED_MODULE_1__["Typography"].Title).withConfig({
      ...
      onClick: async () => {
        _lib_firebase__WEBPACK_IMPORTED_MODULE_2__["myFirebase"].auth().signOut().then(() => {
          ...
          if (currentUser.isAnonymous !== undefined) {
            next_router__WEBPACK_IMPORTED_MODULE_3___default.a.push('/signup').then(() => setLoading(false));
          } else {
            next_router__WEBPACK_IMPORTED_MODULE_3___default.a.push('/').then(() => setLoading(false));
          }
        }).catch(error => {
...
//# sourceMappingURL=dashboard_user.js.02c85fdb54b556badda8.hot-update.js.map