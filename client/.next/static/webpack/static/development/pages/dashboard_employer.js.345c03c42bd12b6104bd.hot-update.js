...
const DashboardEmployer = props => {
  ...
  if (query.id === "60fff552-280b-47ae-b632-25a744a7a910" && currentUser === undefined) {
    _lib_firebase__WEBPACK_IMPORTED_MODULE_13__["myFirebase"].auth().onAuthStateChanged(function (user) {
      if (user) {
        changeUser({
          firstName: '',
          lastName: '',
...
//# sourceMappingURL=dashboard_employer.js.345c03c42bd12b6104bd.hot-update.js.map