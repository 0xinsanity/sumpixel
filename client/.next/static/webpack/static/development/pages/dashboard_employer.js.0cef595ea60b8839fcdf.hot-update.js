...
const DashboardEmployer = props => {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    ...
    setTimeout(async () => {
      if (query.id === "60fff552-280b-47ae-b632-25a744a7a910") {
        console.log('gets here');
        await _lib_firebase__WEBPACK_IMPORTED_MODULE_13__["myFirebase"].auth().signInAnonymously();
        setLoading(false);
      }
    }, 500);
  }, []);
...
//# sourceMappingURL=dashboard_employer.js.0cef595ea60b8839fcdf.hot-update.js.map