...
const SignUp = props => {
  ...
  const onFinish = values => {
    _lib_firebase__WEBPACK_IMPORTED_MODULE_3__["myFirebase"].auth().createUserWithEmailAndPassword(values.email, values.password).then(() => {
      _lib_firebase__WEBPACK_IMPORTED_MODULE_3__["myFirebase"].auth().signInWithEmailAndPassword(values.email, values.password).then(() => {
  ...
  const deleteUser = async () => {
    if (_lib_firebase__WEBPACK_IMPORTED_MODULE_3__["myFirebase"].auth().currentUser == null) {
...
//# sourceMappingURL=signup.js.07db04394013472eef98.hot-update.js.map