...
const Cont = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div`
    display: flex;
    ...
    height: 70vh;
`;
const TypeformContainer = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div`
    position: relative; 
    width: 100%; 
    height: 100%;
`;
...
const QuizScreen = props => {
  ...
  const typeform = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(null);
  const designerTypes = [{
    key: 0,
    name: "UI",
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    if (typeform) {
      _typeform_embed__WEBPACK_IMPORTED_MODULE_7__["makeWidget"](undefined.el, currentQuiz.link, {
        hideFooter: true,
        hideHeaders: true,
        opacity: 1
      });
  ...
  }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(TypeformContainer, {
    ref: typeform
...
//# sourceMappingURL=dashboard_user.js.0471c9472507c16e4c13.hot-update.js.map