...
const FormBusinessData = props => {
  ...
  const onFinish = values => {
    ...
    _lib_firebase__WEBPACK_IMPORTED_MODULE_3__["storage_ref"].child('resumes/' + currentUser.id + '.pdf').put(res["originFileObj"]).then(snapshot => {
      const newEmployer = {
...
//# sourceMappingURL=signup.js.5197c2fa81a8e495e7d8.hot-update.js.map