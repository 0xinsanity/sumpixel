...
const Onboard = props => {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    async function isAccountCreated() {
      const res = await Object(_lib_server__WEBPACK_IMPORTED_MODULE_8__["getUser"])(firebaseUser.uid);
    ...
    if (firebaseUser !== null) {
      if (isAccountCreated()) {// TODO: Retrieve user and update
      } else {
        changeUser({
...
//# sourceMappingURL=index.js.52c41a7869743e04da94.hot-update.js.map