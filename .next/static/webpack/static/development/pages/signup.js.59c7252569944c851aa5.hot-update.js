...
/* harmony import */ var _OnboardingFlow_Employers_Verification__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_OnboardingFlow_Employers_Verification__WEBPACK_IMPORTED_MODULE_9__);
...
const Onboard = props => {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    async function findUser() {
      ...
      if (user['user_exists'] !== undefined || employer['user_exists'] !== undefined) {
        // Works for both
        changeUser({
  ...
  switch (currentStep) {
    ...
    case 2:
      if (navBarStatus == _model_model__WEBPACK_IMPORTED_MODULE_4__["NavBarStatus"].Employer) {
        ...
        currentForm = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_OnboardingFlow_Employers_Verification__WEBPACK_IMPORTED_MODULE_9___default.a, {
          changeStep: change => changeStep(currentStep + change),
          currentUser: currentUser,
          changeCurrentUser: async user => await updateEmployer(user)
        });
...
//# sourceMappingURL=signup.js.59c7252569944c851aa5.hot-update.js.map